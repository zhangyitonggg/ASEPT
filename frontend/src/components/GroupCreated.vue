    ...
    <v-row justify="center">
      <v-dialog v-model="dialog" max-width="50%">
        <v-card>
          ...
          <v-card-text>
            <v-text-field label="群名" required filled v-model="modified_group.group_name"></v-text-field>
        ...
        <v-card>
          ...
          <v-card-text>
            <v-container>
              <v-row>
                <v-col cols="12">
                  <v-text-field label="群名*" required v-model="newGroup.group_name"></v-text-field>
                </v-col>
                <v-col cols="12">
                  <v-textarea label="描述" required auto-grow v-model="newGroup.description"></v-textarea>
                </v-col>
                <v-col cols="12">
                  <v-checkbox label="需要密码" v-model="newGroup.need_password"></v-checkbox>
                </v-col>
          ...
          <v-card-actions>
            <v-spacer></v-spacer>
            <v-btn color="primary" text @click.stop="submitNewGroup"> 保存 </v-btn>
            <v-btn color="error" text @click="createDialog = false"> 取消 </v-btn>
          </v-card-actions>
          <!-- 
          <v-card-actions>
            <v-btn
